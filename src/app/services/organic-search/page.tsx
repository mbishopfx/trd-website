...
export const metadata: Metadata = {
  ...
  description: 'True Rank Digital provides organic search optimization services with keyword research, content optimization, and Google visibility enhancement.',
  keywords: 'organic search, search optimization, keyword research, True Rank Digital, content optimization, Google visibility',
...
export default function OrganicSearchPage() {
  const faqs = [{ question: "What is organic search optimization?", answer: "Organic search optimization is the process of improving your website's visibility in unpaid search engine results. True Rank Digital provides organic search services including keyword research, content optimization, technical optimization, and link building to increase your rankings and traffic from Google, Bing, and other search engines." }];
    ...
    <>
      <GEOSchema 
        ...
        pageData={{ 
          ...
          description: "Comprehensive organic search optimization with keyword research, content optimization, technical optimization, and link building to increase rankings in Google, Bing, and other search engines.", 
          url: "https://truerankdigital.com/services/organic-search", 
          keywords: ["organic search", "search optimization", "keyword research"], 
          category: "Organic Search", 
          serviceType: "Search Optimization", 
          areaServed: ["United States"] 
        }} 
        breadcrumbs={[{ name: "Home", url: "https://truerankdigital.com" }, { name: "Services", url: "https://truerankdigital.com/services" }, { name: "Organic Search", url: "https://truerankdigital.com/services/organic-search" }]} 
        entities={{ 
          primary: ["True Rank Digital", "Organic Search", "Search Optimization"], 
          secondary: ["Keyword Research", "Content Optimization"],
          mentions: [
            { type: "Organization", name: "Google", sameAs: "https://www.wikidata.org/wiki/Q95", description: "Primary search engine" }, 
            { type: "SoftwareApplication", name: "Google Search Console", sameAs: "https://www.wikidata.org/wiki/Q1503528", description: "Search optimization tool" }, 
            { type: "Organization", name: "Schema.org", sameAs: "https://www.wikidata.org/wiki/Q845256", description: "Structured data vocabulary" }
          ]
        }}
        includeFAQ={true}
        faqs={faqs}
