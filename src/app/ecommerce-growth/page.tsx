...
export default function EcommerceGrowthPage() {
  ...
  return (
    <>
      ...
      <article className="pt-16 min-h-screen bg-brand-obsidian text-white"><section className="py-20"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h1 className="text-4xl lg:text-6xl font-heading font-bold text-white mb-6">Scale Your <strong className="text-brand-primary">Online Store</strong> with E-commerce Growth Services</h1><p className="text-xl text-gray-400 max-w-4xl mx-auto mb-12"><strong>True Rank Digital</strong> provides <strong>e-commerce growth services</strong> with product optimization, conversion rate optimization, and e-commerce SEO strategies designed to increase online sales.</p><h2 className="text-3xl font-heading font-bold text-white mb-8">How <strong className="text-brand-primary">E-commerce Growth</strong> Services Increase Sales</h2><div className="glass-card p-8"><div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-6"><ShoppingCart className="w-10 h-10 text-white" /></div><h2 className="text-2xl font-heading font-bold text-white mb-4">Grow Your <strong className="text-brand-primary">E-commerce</strong> Revenue</h2><a href="/contact" className="inline-flex items-center space-x-2 px-8 py-4 bg-orange-600 text-white font-semibold text-lg rounded-full hover:bg-orange-700 transition-colors duration-300"><TrendingUp className="w-5 h-5" /><span>Start E-commerce Growth</span></a></div></div></section></article>
    </>
  );
}
