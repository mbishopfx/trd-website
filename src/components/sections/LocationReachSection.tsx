              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 bg-white/50 rounded-xl">
                    ...
                    <div className="text-xs text-brand-dark/60">24/7 Support</div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-brand-dark/10">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className="text-xs text-brand-dark/60">States Served</div>
                    </div>
                    <div>
                      <div className="text-xl font-bold text-brand-secondary">15+</div>
                      <div className="text-xs text-brand-dark/60">Countries</div>
                    </div>
                    <div>
                      <div className="text-xl font-bold text-brand-accent">24/7</div>
                      <div className="text-xs text-brand-dark/60">Available</div>
                    </div>
                  </div>
                </div>
              </div>
