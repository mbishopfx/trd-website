      ...
      <div className="bg-brand-obsidian/20 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-white">Team Platform Software Services</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="flex items-center justify-center space-x-4 mb-6">
              <div className="w-16 h-16 bg-brand-obsidian/20 rounded-2xl flex items-center justify-center">
              ...
              <div className="space-y-4">
                {technicalCapabilities.map((capability, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    viewport={{ once: true }}
                    className="flex items-start space-x-4 p-4 rounded-lg hover:bg-brand-obsidian/20 transition-colors duration-300"
                  >
                    <CheckCircle className="w-6 h-6 text-brand-primary flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-bold text-white mb-1">{capability.technology}</h4>
