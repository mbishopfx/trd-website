            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="text-center p-4 bg-brand-obsidian/10 rounded-xl backdrop-blur-sm"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="pblue pblue-lg pblue-brand max-w-none">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass-card p-8 lg:p-10 bg-gradient-to-br from-brand-light/30 to-brand-obsidian border-l-4 border-brand-primary"
            >
            ...
            {guides.map((guide, index) => (
              ...
              >
                <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        ...
                        <h3 className="text-xl lg:text-2xl font-heading font-bold text-white group-hover:text-brand-primary transition-colors duration-300">
                          {guide.title}
                        </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {guide.topics.map((topic, i) => (
                        <span key={i} className="px-3 py-1 bg-brand-obsidian/50 text-gray-400 text-sm rounded-full">
                          {topic}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="bg-brand-obsidian/30 rounded-xl p-6">
