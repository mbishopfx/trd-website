...
export default function PrivacyPolicyPage() {
  return (
    <div className="pt-16 min-h-screen bg-brand-obsidian">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pblue pblue-lg max-w-none">
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">How We Use Information</h2>
                <p className="text-gray-400 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">Cookies and Tracking Technologies</h2>
                <p className="text-gray-400 leading-relaxed mb-4">
                ...
                <p className="mt-4 text-gray-400">You can control the use of cookies at the individual browser level, but if you choose to disable cookies, it may limit your use of certain features or functions on our website.</p>
              </section>

              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">SMS Messaging & A2P 10DLC Compliance</h2>
                <p className="text-gray-400 leading-relaxed mb-4">
                ...
                <div className="space-y-4 text-gray-400">
                  <div>
                    <h3 className="text-xl font-bold text-white">How Consent is Obtained</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Types of Messages</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Unsubscribing and Opt-out</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Fees and Liability</h3>
                    <p>Message and data rates may apply from your carrier. Carriers are not responsible for delayed or undelivered messages.</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">Age Requirement</h3>
              ...
              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">Phone Number & Data Sharing</h2>
                <p className="text-gray-400 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">Your Data Rights</h2>
                <p className="text-gray-400 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">Data Protection</h2>
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-brand-obsidian rounded-lg">
                  <p className="text-white"><strong>Email:</strong> privacy@truerankdigital.com</p>
                  <p className="text-white"><strong>Phone:</strong> (732) 475-0139</p>
                  <p className="text-white"><strong>Address:</strong> 288 Summerhill Rd, suite 3, East Brunswick, NJ 08816</p>
                </div>
              </section>
            </div>
          </div>
