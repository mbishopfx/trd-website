...
export default function EcommerceEnterprisePage() {
  ...
  return (
    <>
      ...
      <article className="pt-16 min-h-screen bg-brand-obsidian text-white"><section className="py-20"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><h1 className="text-4xl lg:text-6xl font-heading font-bold text-white mb-6">SEO Services for <strong className="text-brand-primary">E-commerce Enterprise</strong> - True Rank Digital Solutions</h1><p className="text-xl text-gray-400 max-w-4xl mx-auto mb-12"><strong>True Rank Digital</strong> serves <strong>e-commerce enterprise</strong> businesses with specialized SEO strategies for online stores and product catalogs.</p><h2 className="text-3xl font-heading font-bold text-white mb-8">How True Rank Digital Serves <strong className="text-brand-primary">E-commerce Enterprise</strong> Businesses</h2><div className="glass-card p-8 mb-12"><p className="text-gray-400 leading-relaxed">Our <strong>e-commerce SEO services</strong> include product page optimization, category page SEO, technical optimization for large catalogs, and conversion rate optimization designed to increase online sales.</p></div><div className="glass-card p-8"><div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-6"><ShoppingCart className="w-10 h-10 text-white" /></div><h2 className="text-2xl font-heading font-bold text-white mb-4">Grow Your <strong className="text-brand-primary">E-commerce</strong> Business</h2><a href="/contact" className="inline-flex items-center space-x-2 px-8 py-4 bg-orange-600 text-white font-semibold text-lg rounded-full hover:bg-orange-700 transition-colors duration-300"><TrendingUp className="w-5 h-5" /><span>Get E-commerce Strategy</span></a></div></div></section></article>
    </>
  );
}
