        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="glass-card p-8 space-y-8">
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">1. Services Agreement</h2>
                <p className="text-gray-400 leading-relaxed">
                  True Rank Digital provides digital marketing services including SEO, Google Business Profile management, 
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">2. Payment Terms</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">3. Service Performance</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">4. Client Responsibilities</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">7. Service Termination</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">8. Limitation of Liability</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">9. SMS Messaging Terms</h2>
                <div className="text-gray-400 leading-relaxed space-y-4">
                  <p>
                    By providing your phone number and opting in to receive SMS from True Rank Digital, you agree to the following terms:
                  </p>
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">10. Changes to Terms</h2>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-heading font-bold text-white mb-4">10. Contact Information</h2>
                <p className="text-gray-400 leading-relaxed">
                  For questions about these terms or our services, contact us at:
                </p>
                <div className="mt-4 p-4 bg-brand-obsidian/30 rounded-lg">
                  <p className="text-white font-semibold">True Rank Digital</p>
                  <p className="text-gray-400">288 Summerhill Rd, suite 3, East Brunswick, NJ 08816</p>
                  <p className="text-gray-400">Phone: (732) 475-0139</p>
                  <p className="text-gray-400">Email: info@truerankdigital.com</p>
                </div>
              </div>
              ...
              <div className="border-t border-brand-dark/10 pt-6">
                <p className="text-gray-500 text-sm">
                  ...
                  These terms are effective for all services provided by True Rank Digital.
                </p>
              </div>
            </div>
          </motion.div>
