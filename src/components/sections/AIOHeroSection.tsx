...
export default function AIOHeroSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-brand-accent via-brand-blue to-brand-primary text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {[
            ...
            >
              <div className="text-gray-300 group-hover:text-white mb-4 flex justify-center group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
